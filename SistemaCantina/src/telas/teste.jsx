    ...
    function TesteAPI() {
        ...
        const loginA = async(e) => {
            ...
            api.post('/loginA', dados)
                .then((data) => {
                    ...
                    if(data.status==200){
                        Cookies.set('logado', JSON.stringify({logado: true, admin: 'twin'}), {expires: 1/720});
                    }
                })
        ...
        return(
            <>
                ...
                <button onClick={sail}>
                    <img src="https://preview.redd.it/am-i-really-the-only-person-who-felt-prigizhins-pointing-v0-48b56igp1mdb1.png?width=384&format=png&auto=webp&s=1e65e690606712cf275bf1620c6202811a30ba16" />
                    Saia
                </button>
            </>
        )
